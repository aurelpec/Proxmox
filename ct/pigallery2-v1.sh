...
echo -e "${RD}
   ...
   / __ \(_) ____/___ _/ / /__  _______  _|__ \
  / /_/ / / / __/ __ `/ / / _ \/ ___/ / / /_/ /
 / ____/ / /_/ / /_/ / / /  __/ /  / /_/ / __/ 
/_/   /_/\____/\__,_/_/_/\___/_/   \__, /____/ 
                               v1 /____/       
${CL}"
}
function msg_info() {
...
export PCT_OPTIONS="
  ...
  $PW
"
bash -c "$(wget -qLO - https://raw.githubusercontent.com/aurelpec/Proxmox/main/ct/create_lxc.sh)" || exit
msg_info "Starting LXC Container"
pct start $CTID
msg_ok "Started LXC Container"
lxc-attach -n $CTID -- bash -c "$(wget -qLO - https://raw.githubusercontent.com/aurelpec/Proxmox/main/setup/$var_install.sh)" || exit
